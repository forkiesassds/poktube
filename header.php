...
<link rel="stylesheet" type="text/css" href="img/chaziz_edit.css">
...
<div class="ui menu inverted">
	<div class="item"><img src="img/logo.png" alt="[squareBracket]" border="0" style="transform: scale(6);margin-right: 78px;padding-left: 13px;"></img></div>
