...
function VLPlayer(e) {
  ...
  n = $('<video></video>'),
  a = n[0],
  d = 'video/mp4; codecs="avc1.42E01E, mp4a.40.2"',
  h = e.mode ? e.mode : 'html5',
  o = e.src ? e.src : '',
  (t = e.id ? e.id : $('.vlPlayer:last')).empty(),
  $('head').append('<style>\t\t.vlPlayer{position:relative;overflow:hidden;width:100%;height:100%}\t\t.vlPlayer.error{display:table;table-layout:fixed;background:#000;text-align:center}\t\t.vlPlayer.error>span{display:table-cell!important;vertical-align:middle;text-align:center;color:#fff;font-family:Arial;font-size:16px;width:70%}\t</style>'),
  'flash' != h && a.canPlayType && a.canPlayType(d) || swfobject.hasFlashPlayerVersion('9') && (h = 'flash', p = vlpflash.length, v = 'flplayer' + p, n = $('<div style="width:100%; height:100%;"><div id="' + v + '"></div></div>'), a = {
    src: '',
    volume: 1,
    duration: 0,
    currentTime: 0,
    ...
    setVolume: function (e) {
      a.volume = e,
      getFlashMovie(v).setVolume(e)
    },
    setSource: function (e) {
      getFlashMovie(v).clearVideo(),
      getFlashMovie(v).addVideo(e),
  ...
  this.initialize = function () {
    ...
    l.autoplay && l.play(),
    F && F(),
    void 0 !== Storage && localStorage.lastVol && l.setVolume(localStorage.lastVol),
    i.changePreview(l.preview),
    i.setIntervals(),
    i.resize()
  },
  ...
  this.play = function () {
    $(document).mousemove(),
    y && (t.hasClass('ended') && l.seek(0), t.addClass('playing started'), t.focus(), l.changeURL(o), m = a.play())
  },
  this.pause = function () {
    $(document).mousemove(),
    t.removeClass('playing'),
    y && (void 0 !== m ? m.then(function (e) {
      a.pause()
    }).catch(function (e) {
    }) : a.pause())
  },
  ...
  this.changeURL = function (e) {
    y && a.src != e && ('flash' == h ? a.setSource(e) : n.attr('src', e), o = e)
  },
  ...
  this.setVolume = function (e) {
    y && (e < 0 && (e = 0), e > 1 && (e = 1), 'flash' == h ? a.setVolume(e) : a.volume = e, i.changeVolume(e), t.removeClass('vol25 vol50 vol75 muted'), 0 == e ? t.addClass('muted') : e < 0.25 ? t.addClass('vol25') : e < 0.5 ? t.addClass('vol50') : e < 0.75 && t.addClass('vol75'), void 0 !== Storage && (localStorage.lastVol = a.volume))
  },
  this.mute = function () {
    t.addClass('muted'),
    u = a.volume,
  ...
  this.setRate = function (e) {
    e < 0.25 || e > 4 || 'flash' != h && (i.rateChange && i.rateChange(e), a.playbackRate = e, c = e)
  },
  this.toggleFull = function (e) {
    ...
    a = t[0];
    for (var i = 0; i < n.length; i++) if (o) {
      if (n[i] in document) return !0 !== e && document[n[i]](),
      !0
    } else if (n[i] in a) return !0 !== e && a[n[i]](),
    !0;
    return !1
  },
  this.changeButtonColor = function (e) {
    t.removeClass('redBt orangeBt goldBt oliveBt greenBt tealBt blueBt violetBt pinkBt magentaBt whiteBt'),
    t.addClass(e + 'Bt')
  },
  this.changeBackground = function (e) {
    t.removeClass('redBg orangeBg goldBg oliveBg greenBg tealBg blueBg violetBg pinkBg magentaBg whiteBg blackBg'),
    t.addClass(e + 'Bg')
  },
  this.changeDuration = function () {
    ...
    w = a.duration,
    l.duration = w,
    i.changeDuration(l.duration),
    l.start && l.seek(l.start),
    t.hasClass('playing') && l.play()
  },
  this.playerKey = function (e) {
    var n = a.currentTime,
    o = a.volume;
    return 37 == e.keyCode ? (l.seek(n - 1), !1) : 39 == e.keyCode ? (l.seek(n + 1), !1) : 38 == e.keyCode ? (l.setVolume(o + 0.1), !1) : 40 == e.keyCode ? (l.setVolume(o - 0.1), !1) : 188 == e.keyCode ? t.hasClass('playing') ? (l.setRate(c / 2), !1) : (l.seek(n - 0.0333333333), !1) : 190 == e.keyCode ? t.hasClass('playing') ? (l.setRate(2 * c), !1) : (l.seek(n + 0.0333333333), !1) : 77 == e.keyCode ? (l.toggleMute(), !1) : 32 == e.keyCode ? (l.toggle(), !1) : 13 == e.keyCode ? (l.toggleFull(), !1) : void 0
  },
  this.bufferUpdate = function () {
    ...
    n = a.buffered,
    o = n.length;
    if (0 != o) if (Math.round(n.end(0)) != Math.round(l.duration)) {
      for (var s = o - 1; s >= 0; s--) if (t >= n.start(s) && t <= n.end(s)) {
        e = n.end(s) / l.duration * 100,
        i.changeBuffer(e + '%');
        break
      }
  ...
  this.ended = function () {
    l.onended && l.onended(),
    t.hasClass('loop') ? (l.seek(0), l.play()) : (l.seek(l.duration), i.changeElapsed(l.duration), t.addClass('ended'), l.pause())
  },
  ...
  this.fullChange = function () {
    ...
    for (var n = 0; n < e.length; n++) if (e[n] in document) {
  ...
  this.mouseMove = function (e) {
    e.pageX && (l.mouseX = e.pageX, l.mouseY = e.pageY),
    t.hasClass('full') && (null != s && clearTimeout(s), t.removeClass('hidemouse'), i.mouseHide && i.mouseHide(), s = setTimeout(function () {
      t.hasClass('playing') ? t.addClass('hidemouse') : t.removeClass('hidemouse'),
      s = null,
      i.mouseHide && i.mouseHide()
    }, 2000))
  },
  ...
  this.context = function (e) {
    ...
    for (var u in r) r[u] = $('<li tabindex="-1">' + r[u] + '</li>'),
    f.append(r[u]);
    ...
    f.keydown(function (e) {
      ...
      switch (n) {
        ...
        case 38:
          (--s < 0 || s >= a) && (s = a - 1),
          f.trigger('mouseleave'),
          f.children().eq(s).addClass('hover');
          break;
        case 40:
          (++s < 0 || s >= a) && (s = 0),
          f.trigger('mouseleave'),
    ...
    r.copy.click(function () {
      i.hiddenUrl.val(l.videoUrl),
      i.hiddenUrl.focus().select(),
    ...
    r.copyT.click(function () {
      ...
      i.hiddenUrl.val(l.videoUrl + '#t=' + e),
      i.hiddenUrl.focus().select(),
      document.execCommand('copy'),
      i.hiddenUrl.blur(),
      t.focus()
    ...
    t.hasClass('loop') && r.loop.addClass('checked'),
    t.hasClass('muted') && r.mute.addClass('checked'),
    t.hasClass('hd720p') && r.thd.addClass('checked'),
    l.hd || r.thd.remove(),
    t.hasClass('full') ? r.efull.remove() : r.cfull.remove(),
    l.videoUrl || (r.copy.remove(), r.copyT.remove()),
    f.mousedown(!1),
    f.animate({
      opacity: 1
    }, 250),
    t.append(f),
    n + f.width() > $(window).width() && ((n -= f.width()) < 0 && (n = 0), f.css('left', n)),
    o + f.height() > $(window).height() && ((o -= f.height()) < 0 && (o = 0), f.css('top', o)),
    f.focus(),
    !1
  },
  C = function () {
    if (!k && l.videoUrl && (k = '123'), r || B) return !1;
    r = setInterval(function () {
      if (!w) return b();
      var e = Math.round(a.currentTime);
      - 1 == S.indexOf(e) && S.push(e);
      var t = w <= 60 && S.length >= 0.62 * w,
      n = w > 60 && S.length >= 33;
      (t || n) && k && '123' != k && !B && (B = !0)
    }, 500),
    'undefined' == typeof watchinit && setInterval(function () {
      0 == a.paused && (watchinit = !0)
    }, 1000)
  },
  b = function () {
    r = clearInterval(r)
  ...
  this.hd = !!e.hdsrc,
  this.preview = 'preview' in e ? e.preview : '',
  this.duration = 'duration' in e ? e.duration : 0,
  this.start = 'start' in e ? e.start : 0,
  this.autoplay = !!e.autoplay,
  this.adjust = !!e.adjust,
  this.videoUrl = e.videoUrl ? e.videoUrl : null,
  this.skinPath = e.skin,
  this.buttonColor = e.btcolor ? e.btcolor : 'teal',
  this.background = e.bgcolor ? e.bgcolor : 'white',
  this.onended = e.ended ? e.ended : null;
  var F = e.complete;
  '1' == l.getCookie('vlphd') && e.hdsrc && (t.addClass('hdsrc'), t.addClass('hd720p'), o = e.hdsrc),
  $.getScript(this.skinPath + '/skin.js?' + window.vlpv, function () {
    i = new VLPSkin(l, e.expand, function () {
      t.on('keydown', l.playerKey),
      t.on('contextmenu', l.context),
      t.on('mousedown', l.mouseDown),
      t.on('mousedown', '.vlButton', l.mouseDownBtn),
      n.on('playing', C),
      n.on('waiting pause ended', b),
      n.on('durationchange', l.changeDuration),
      n.on('progress', l.bufferUpdate),
      n.on('seeked', l.seeked),
      n.on('error', l.error),
      $(document).on('webkitfullscreenchange mozfullscreenchange MSFullscreenChange fullscreenchange', l.fullChange),
      $(document).on('keydown mousemove', l.mouseMove),
      $(document).on('mouseup', l.mouseUp),
      l.duration > 0 && (i.changeElapsed(0), i.changeDuration(l.duration)),
      'flash' == h ? l.initializeFlash() : l.initialize()
    })
  })
}
...
var swfobject = function () {
  ...
  B = function () {
    ...
    if (typeof p.plugins != l && typeof p.plugins[r] == s) !(g = p.plugins[r].description) || typeof p.mimeTypes != l && p.mimeTypes[u] && !p.mimeTypes[u].enabledPlugin || (v = !0, c = !1, g = g.replace(/^.*\s+(\S+\s+\S+$)/, '$1'), d[0] = parseInt(g.replace(/^(.*)\..*$/, '$1'), 10), d[1] = parseInt(g.replace(/^.*\.(.*)\s.*$/, '$1'), 10), d[2] = /[a-zA-Z]/.test(g) ? parseInt(g.replace(/^.*[a-zA-Z]+(.*)$/, '$1'), 10) : 0);
      ...
      m && (g = m.GetVariable('$version')) && (c = !0, g = g.split(' ') [1].split(','), d = [
        parseInt(g[0], 10),
        parseInt(g[1], 10),
        parseInt(g[2], 10)
      ])
  ...
  function F(e) {
    if (typeof f.addEventListener != l) f.addEventListener('load', e, !1);
     ...
     else if (typeof f.attachEvent != l) a = 'onload',
    o = e,
    (n = f).attachEvent(a, o),
    w[w.length] = [
      n,
  ...
  function T() {
    ...
    if (e > 0) for (var t = 0; t < e; t++) {
      ...
      if (B.pv[0] > 0) {
        var i = A(n);
        if (i) if (!P(m[t].swfVersion) || B.wk && B.wk < 312) if (m[t].expressInstall && $()) {
          var s = {
          };
          ...
          for (var r = {
          }, u = i.getElementsByTagName('param'), c = u.length, d = 0; d < c; d++) 'movie' != u[d].getAttribute('name').toLowerCase() && (r[u[d].getAttribute('name')] = u[d].getAttribute('value'));
          L(s, r, n, a)
        } else U(i),
        a && a(o);
         else R(n, !0),
        a && (o.success = !0, o.ref = x(n), a(o))
      } else if (R(n, !0), a) {
        var f = x(n);
        f && typeof f.SetVariable != l && (o.success = !0, o.ref = f),
        a(o)
      }
    }
  }
  ...
  function L(o, i, s, r) {
    ...
    var u = A(s);
    if (u) {
      'OBJECT' == u.nodeName ? (e = V(u), t = null) : (e = u, t = s),
      o.id = c,
      (typeof o.width == l || !/%$/.test(o.width) && parseInt(o.width, 10) < 310) && (o.width = '310'),
      (typeof o.height == l || !/%$/.test(o.height) && parseInt(o.height, 10) < 137) && (o.height = '137'),
  ...
  function U(e) {
    if (B.ie && B.win && 4 != e.readyState) {
      ...
      t.parentNode.replaceChild(V(e), t),
  ...
  function V(e) {
    ...
    if (B.win && B.ie) t.innerHTML = e.innerHTML;
      ...
      if (n) {
        var a = n.childNodes;
        if (a) for (var o = a.length, i = 0; i < o; i++) 1 == a[i].nodeType && 'PARAM' == a[i].nodeName || 8 == a[i].nodeType || t.appendChild(a[i].cloneNode(!0))
      }
    }
    return t
  }
  function j(e, t, n) {
    ...
    if (o) if (typeof e.id == l && (e.id = n), B.ie && B.win) {
      var i = '';
      ...
      o.outerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + i + '>' + c + '</object>',
      y[y.length] = e.id,
      a = A(e.id)
    } else {
      var f = N(s);
    ...
    if (!B.ie || !B.mac) {
      ...
      if (r) {
        ...
        if (a && (o = null, i = null), !o || i != u) {
          ...
          o = r.appendChild(c),
          B.ie && B.win && typeof h.styleSheets != l && h.styleSheets.length > 0 && (o = h.styleSheets[h.styleSheets.length - 1]),
          i = u
        }
  ...
  return {
    ...
    embedSWF: function (e, t, n, a, o, i, r, u, c, d) {
      ...
      B.w3 && !(B.wk && B.wk < 312) && e && t && n && a && o ? (R(t, !1), E(function () {
        ...
        if (c && typeof c === s) for (var p in c) h[p] = c[p];
        h.data = e,
        h.width = n,
        h.height = a;
        var v = {
        };
        if (u && typeof u === s) for (var g in u) v[g] = u[g];
        if (r && typeof r === s) for (var m in r) typeof v.flashvars != l ? v.flashvars += '&' + m + '=' + r[m] : v.flashvars = m + '=' + r[m];
        if (P(o)) {
          var y = j(h, v, t);
          h.id == t && R(t, !0),
          f.success = !0,
    ...
    getQueryParamValue: function (e) {
      ...
      if (t) {
        ...
        for (var n = t.split('&'), a = 0; a < n.length; a++) if (n[a].substring(0, n[a].indexOf('=')) == e) return D(n[a].substring(n[a].indexOf('=') + 1))
      }
      return ''
    },
    expressInstallCallback: function () {
      if (b) {
        var o = A(c);
        o && e && (o.parentNode.replaceChild(e, o), t && (R(t, !0), B.ie && B.win && (e.style.display = 'block')), n && n(a)),
        b = !1
      }
    }
  }
